        ...
        return (
            <div className="task" style={{ backgroundColor: this.props.color }}>
                <div className="task-inner">
                        ...
                        <div className="task-date">
                            {
                                this.props.task.date != null ?
                                    <input
                                        type="date"
                                        value={new Date(this.props.task.date).toISOString().split('T')[0]} 
                    ...
                    <button aria-label="Delete Task" className="task-action" onClick={this.deleteTask}>
